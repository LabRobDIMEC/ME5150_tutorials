...
#funciones para encontrar centro global de masa aqui

#dibujar el centro de masa global
cv2.circle(undistor_image, centro_global, 5, (255, 0, 0), -1)
#se redimensiona la imagen para que sea mas pequeña
resized_img_contornos = resize_image(undistor_image)
cv2.imshow('Circulos', resized_img_contornos)
